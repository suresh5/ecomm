                                    ...
                                    <div class="tf-product-info-choose-option">
                                        <div class="variant-picker-item">
                                            ...
                                            <div class="variant-picker-values gap12">
                                                ...
                                                <label class="style-text-1 style-rounded radius-60 color-btn" for="values-beige" data-value="Beige" data-color="beige">
                                                    <span class="circle-color bg-color-beige"></span>
                                                    <span class="text-title">Beige</span>
                                                </label>
                                                <input id="values-gray" type="radio" name="color1">
                                                <label class="style-text-1 style-rounded radius-60 color-btn" data-price="79.99" for="values-gray" data-value="Gray" data-color="gray">
                                                    <span class="circle-color bg-color-gray"></span>
                                                    <span class="text-title">Gray</span>
                                                </label>
                                                <input id="values-grey" type="radio" name="color1">
                                                <label class="style-text-1 style-rounded radius-60 color-btn" data-price="89.99" for="values-grey" data-value="Grey" data-color="grey">
                                                    <span class="circle-color bg-color-grey"></span>
                                                    <span class="text-title">Grey</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="variant-picker-item">
