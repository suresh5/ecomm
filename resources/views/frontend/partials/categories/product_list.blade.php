@php
    $products = [
        [
            ...
            'price_old' => '$98.00',
            'price' => '$219.99',
            'img1' => 'frontend/images/products/womens/women-19.jpg',
            'img2' => 'frontend/images/products/womens/women-20.jpg',
            ...
            'colors' => [
                ['label' => 'Green', 'color' => 'bg-light-green', 'img' => 'frontend/images/products/womens/women-19.jpg'],
                ['label' => 'Grey', 'color' => 'bg-grey-2', 'img' => 'frontend/images/products/womens/women-1.jpg'],
                ['label' => 'White', 'color' => 'bg-white', 'img' => 'frontend/images/products/womens/women-8.jpg']
            ],
            'sizes' => ['S', 'M', 'L', 'XL', 'XXL']
        ],
        [
            ...
            'price_old' => '$120.00',
            'price' => '$85.00',
            'img1' => 'frontend/images/products/womens/women-5.jpg',
            'img2' => 'frontend/images/products/womens/women-6.jpg',
            'description' => 'Stylish puffer jacket perfect for winter. Water-resistant and ethically made.',
            'colors' => [
                ['label' => 'Black', 'color' => 'bg-black', 'img' => 'frontend/images/products/womens/women-5.jpg'],
                ['label' => 'Navy', 'color' => 'bg-dark-blue', 'img' => 'frontend/images/products/womens/women-6.jpg']
            ],
            'sizes' => ['S', 'M', 'L', 'XL']
        ],
        [
            ...
            'price_old' => '$75.00',
            'price' => '$65.00',
            'img1' => 'frontend/images/products/womens/women-7.jpg',
            'img2' => 'frontend/images/products/womens/women-8.jpg',
            'description' => 'Comfortable and stretchy jeans for everyday wear. Sustainably sourced materials.',
            'colors' => [
                ['label' => 'Blue', 'color' => 'bg-blue', 'img' => 'frontend/images/products/womens/women-7.jpg']
            ],
            'sizes' => ['XS', 'S', 'M', 'L', 'XL']
        ],
        [
            ...
            'price_old' => '$50.00',
            'price' => '$39.99',
            'img1' => 'frontend/images/products/womens/women-9.jpg',
            'img2' => 'frontend/images/products/womens/women-10.jpg',
            'description' => 'Soft knit sweater made from recycled yarns. Ideal for layering.',
            'colors' => [
                ['label' => 'Beige', 'color' => 'bg-light-brown', 'img' => 'frontend/images/products/womens/women-9.jpg'],
                ['label' => 'Pink', 'color' => 'bg-pink', 'img' => 'frontend/images/products/womens/women-10.jpg']
            ],
            'sizes' => ['S', 'M', 'L']
        ],
        [
            ...
            'price_old' => '$110.00',
            'price' => '$95.00',
            'img1' => 'frontend/images/products/womens/women-11.jpg',
            'img2' => 'frontend/images/products/womens/women-12.jpg',
            'description' => 'Breathable linen dress with tie waist and side pockets.',
            'colors' => [
                ['label' => 'Olive', 'color' => 'bg-olive', 'img' => 'frontend/images/products/womens/women-11.jpg']
            ],
            'sizes' => ['S', 'M', 'L', 'XL']
        ],
        [
            ...
            'price_old' => '$150.00',
            'price' => '$119.99',
            'img1' => 'frontend/images/products/womens/women-13.jpg',
            'img2' => 'frontend/images/products/womens/women-14.jpg',
            'description' => 'Tailored blazer with waist belt. Perfect for workwear.',
            'colors' => [
                ['label' => 'Camel', 'color' => 'bg-light-brown', 'img' => 'frontend/images/products/womens/women-13.jpg']
            ],
            'sizes' => ['S', 'M', 'L', 'XL']
        ],
        [
            ...
            'price_old' => '$25.00',
            'price' => '$18.00',
            'img1' => 'frontend/images/products/womens/women-15.jpg',
            'img2' => 'frontend/images/products/womens/women-16.jpg',
            'description' => 'Basic cotton t-shirt made from 100% organic cotton.',
            'colors' => [
                ['label' => 'White', 'color' => 'bg-white', 'img' => 'frontend/images/products/womens/women-15.jpg'],
                ['label' => 'Grey', 'color' => 'bg-grey-2', 'img' => 'frontend/images/products/womens/women-16.jpg']
            ],
            'sizes' => ['XS', 'S', 'M', 'L']
        ],
        [
            ...
            'price_old' => '$60.00',
            'price' => '$45.00',
            'img1' => 'frontend/images/products/womens/women-17.jpg',
            'img2' => 'frontend/images/products/womens/women-18.jpg',
            'description' => 'Flowy skirt with a high-rise waistband and floral print.',
            'colors' => [
                ['label' => 'Red', 'color' => 'bg-red', 'img' => 'frontend/images/products/womens/women-17.jpg']
            ],
            'sizes' => ['S', 'M', 'L']
        ],
        [
            ...
            'price_old' => '$89.00',
            'price' => '$69.99',
            'img1' => 'frontend/images/products/womens/women-21.jpg',
            'img2' => 'frontend/images/products/womens/women-22.jpg',
            'description' => 'Elegant wrap dress with v-neckline and flared hem.',
            'colors' => [
                ['label' => 'Blue', 'color' => 'bg-blue', 'img' => 'frontend/images/products/womens/women-21.jpg']
            ],
            'sizes' => ['S', 'M', 'L', 'XL']
        ],
        [
            ...
            'price_old' => '$55.00',
            'price' => '$40.00',
            'img1' => 'frontend/images/products/womens/women-23.jpg',
            'img2' => 'frontend/images/products/womens/women-24.jpg',
            'description' => 'Soft fleece joggers with elastic waistband and pockets.',
            'colors' => [
                ['label' => 'Grey', 'color' => 'bg-grey-2', 'img' => 'frontend/images/products/womens/women-23.jpg']
            ],
            'sizes' => ['S', 'M', 'L', 'XL']
        ]
    ];
