...
<body class="preload-wrapper">
    ...
    <div id="wrapper">
        <!-- Top Bar -->
        @include('frontend.partials.common.topbar')
        ...
        <!-- Toolbar Bottom -->
        @include('frontend.partials.common.toolbar')
    </div>

        @include('frontend.partials.common.mobile_menu')
        @include('frontend.partials.common.mobile_categories')
         <!-- Modal Bottom -->
        @include('frontend.partials.common.modal.modal_quickview')
        @include('frontend.partials.common.modal.modal_shoppingcart')
        @include('frontend.partials.common.modal.modal_wishlist')
        <!-- /Modal Bottom -->
    <!-- Scripts -->
