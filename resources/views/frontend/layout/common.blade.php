                        ...
                        <div class="col-xl-8 col-md-4 col-6">
                            <div class="wrapper-header-left justify-content-center justify-content-xl-start">
                                <a href="index.html" class="logo-header">
                                    <img src="images/logo/logo-white.svg" alt="logo" class="logo">
                                </a>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="mega-menu-item">
                                                            ...
                                                            <li>
                                                                <a href="product-deals-grid.html" class="menu-link-text position-relative">
                                                                    Deals Grid
                                        ...
                                        <div class="tf-cur justify-content-end">
                                            <div class="tf-currencies">
                                                <select class="image-select center style-default type-currencies color-secondary-2">
                                                    <option selected data-thumbnail="images/country/us.svg">USD</option>
                                                    <option data-thumbnail="images/country/vn.svg">VND</option>
                                                    <option data-thumbnail="images/country/fr.svg">EUR</option>
                                                </select>
                                            </div>
                                            <div class="tf-languages">
                    ...
                    <div class="row-demo">
                        ...
                        <div class="demo-item">
                            <a href="home-pickleball.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="images/demo/home-pickleball.jpg" src="images/demo/home-pickleball.jpg" alt="home-pickleball">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-sock-2.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="images/demo/home-sock2.jpg" src="images/demo/home-sock2.jpg" alt="home-sock2">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-bookstore.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="images/demo/home-bookstore.jpg" src="images/demo/home-bookstore.jpg" alt="home-bookstore">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-electronics-store.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="images/demo/home-electronic-store.jpg" src="images/demo/home-electronic-store.jpg" alt="home-electronic-store">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-gaming.html">
                                <div class="demo-image position-relative">
                                    <img class="lazyload" data-src="images/demo/home-gaming-accessory.jpg" src="images/demo/home-gaming-accessory.jpg" alt="home-gaming-accessory">
                                    <div class="demo-label">
                                        <span class="demo-new">New</span>
                                    </div>
                                </div>
                        ...
                        <li class="nav-mb-item active">
                            ...
                            <div id="dropdown-menu-one" class="collapse">
                                <ul class="sub-nav-menu" >
                                    ...
                                    <li><a href="home-electronic.html" class="sub-nav-link active">Electronic Market</a></li>
                                    ...
                                    <li><a href="home-electronics-store.html" class="sub-nav-link">Electronics Store</a></li>
                                    ...
                                    <li><a href="#sub-shop-one" class="sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="sub-shop-one">
                                        ...
                                        <div id="sub-shop-one" class="collapse">
                                            <ul class="sub-nav-menu sub-menu-level-2">
                                                ...
                                                <li><a href="shop-default-list.html" class="sub-nav-link">Default List</a></li>
                                    ...
                                    <li>
                                        ...
                                        <div id="sub-product-three" class="collapse">
                                            <ul class="sub-nav-menu sub-menu-level-2">
                                                ...
                                                <li><a href="product-deals-grid.html" class="sub-nav-link">Deals Grid</a></li>
            ...
            <div class="canvas-body">
                <div class="wd-facet-categories">
                    ...
                    <div id="forWomen" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/avatar/new-in.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">New in</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/avatar/promotion.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Promotion</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/avatar/clothing.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Clothing</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/avatar/shoes.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Shoes</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/avatar/bags.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Bags</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/avatar/accessories.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Accessories</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/avatar/jewelry.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Jewelry</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="wd-facet-categories">
                    ...
                    <div id="forMen" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/avatar/men.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Men</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/avatar/men.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Men</span></a>
                            </li>
                ...
                <div class="wd-facet-categories">
                    ...
                    <div id="forKid" class="collapse">
                        <ul class="facet-body">
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/avatar/kid.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Kid</span></a>
                            </li>
                            <li>
                                <a href="#" class="item link"><img class="avt" src="images/avatar/kid.jpg" alt="avt"><span class="title-sub text-caption-1 text-secondary">Kid</span></a>
                            </li>
