...
<!-- <button type="button" id="add-specification" class="btn btn-sm btn-secondary mt-2">+ Add General Specification</button> -->
 ...
 <div id="spec-groups-wrapper" class="mb-4">
    <!-- Groups will be added dynamically here -->
</div>

<button type="button" class="btn btn-primary btn-sm" id="add-spec-group">+ Add Specification Group</button>
...
document.getElementById('add-spec-group').addEventListener('click', function () {
    ...
    specIndexes[groupIndex] = 1; // first row already exists
    groupIndex++;
});

// Handle clicks inside wrapper
document.addEventListener('click', function (e) {
    // Add new spec to group
