        ...
        <div class="card-body">
            <form method="post" action="{{ route('product.update', $product->id) }}">
                ...
                <div id="simpleProductFields"
                    class="mb-4 {{ old('has_variants', $product->has_variants) ? 'd-none' : '' }}">
                            ...
                            <div class="attribute-section">
                                @foreach ($brandVariants as $variantIndex => $variant)
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @foreach ($variant->attributeValues as $valueObj)
                                            <div class="d-flex attribute-row align-items-center mb-2">
                                                ...
                                                <button type="button"
                                                    class="btn btn-danger btn-sm remove-attribute">×</button>
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="specification-section mb-3">
                                        ...
                                        @foreach ($variant->specifications as $specIndex => $spec)
                                            <div class="d-flex align-items-center mb-2 spec-row">
                                                ...
                                                <button type="button"
                                                    class="btn btn-danger btn-sm remove-spec">×</button>
                                            </div>
                                        @endforeach
                                    ...
                                    <div class="mb-3 border p-2 rounded">
                                        ...
                                        <div class="row g-2">
                                            <div class="col">
                                                <label for="sku_{{ $brandId }}_{{ $loop->index }}"
                                                    class="form-label">SKU</label>
                                                <input type="text"
                                                    name="brand_variants[{{ $brandId }}][{{ $variantIndex }}][sku]"
                                                    class="form-control" placeholder="SKU" value="{{ $variant->sku }}">
                                            </div>
                                            <div class="col">
                                                <label for="price_{{ $brandId }}_{{ $loop->index }}"
                                                    class="form-label">Price</label>
                                                <input type="number"
                                                    name="brand_variants[{{ $brandId }}][{{ $variantIndex }}][price]"
                                                    class="form-control" placeholder="Price"
                                                    value="{{ $variant->price }}">
                                            </div>
                                            <div class="col">
                                                <label for="stock_{{ $brandId }}_{{ $loop->index }}"
                                                    class="form-label">STOCK</label>
                                                <input type="number"
                                                    name="brand_variants[{{ $brandId }}][{{ $variantIndex }}][stock]"
                                                    class="form-control" placeholder="Stock"
                                                    value="{{ $variant->stock }}">
                                            </div>
                                            <div class="col">
                                                <label for="discount_{{ $brandId }}_{{ $loop->index }}"
                                                    class="form-label">Discount</label>
                                                <input type="number"
                                                    name="brand_variants[{{ $brandId }}][{{ $variantIndex }}][discount]"
                        ...
                        <div class="spec-group border p-3 mb-3" data-group-index="{{ $groupIndex }}">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <div>
                                    ...
                                    <input type="text" name="spec_groups[{{ $groupIndex }}][label]"
                                        value="{{ $label }}" placeholder="Enter group label"
                            ...
                            <button type="button" class="btn btn-sm btn-secondary add-spec"
