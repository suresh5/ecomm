<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <hr class="sidebar-divider">
        ...
        <div class="sidebar-heading">
         ...
         {{-- Attributes --}}
     <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#attributeCollapse" aria-expanded="true" aria-controls="attributeCollapse">
     ...
     {{-- Brands --}}
     <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#attributevalueCollapse" aria-expanded="true" aria-controls="attributevalueCollapse">
          <i class="fas fa-table"></i>
          <span>Attribute Value</span>
        </a>
        <div id="attributevalueCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Attribute Value Options:</h6>
            <a class="collapse-item" href="{{route('attribute-values.index')}}">Specification</a>
            <a class="collapse-item" href="{{route('attribute-values.create')}}">Add Specification</a>
          </div>
        </div>
    </li>
